...
<div class="container">
    ...
    <div class="list-group col-md-10 col-md-offset-1">
        ...
        <a href="/CalculIP/Memos/Analyse" class="list-group-item">
        ...
        <a href="/CalculIP/Memos/Classe" class="list-group-item">
        ...
        <a href="/CalculIP/Memos/Structure" class="list-group-item">
        ...
        <a href="/CalculIP/Memos/CIDR" class="list-group-item">
        ...
        <a href="/CalculIP/Memos/Routage" class="list-group-item">
        ...
        <a href="/CalculIP/Memos/SousReseaux" class="list-group-item">
