                ...
                <div class="col-sm-8 col-sm-offset-2">
                    <div class="input-group input-group-sm">
                        ...
                        <span id="conv_request"
                              class="input-group-addon"><?= $converter->getFirstFormat()->getName() ?></span>
                        ...
                        <span class="input-group-addon sr-only">
                            <label for="conv">en <?= $converter->getSecondFormat()->getName() ?></label>
                        </span>

                        <input type="text" id="conv_response" name="reponse" class="form-control"
                               placeholder="en <?= $converter->getSecondFormat()->getName() ?>">
