<div class="panel panel-default">
    <div class="panel-heading" data-toggle="collapse" href="#toCollapseArp">
        <h3 class="panel-title">Si Paquet ARP : <i>Cliquez pour afficher/masquer</i></h3>
    </div>
                ...
                <td>
                    <div class="col-xs-6 col-md-6">
                        <div class="col-xs-12 col-md-12 input-group" id="has">
                            ...
                            <input type="text" class="form-control" placeholder="XXXX" name="ARPhardwareAddressSpace">
                        </div>
                    </div>
                    <div class="col-xs-6 col-md-6">
                        <div class="col-xs-12 col-md-12 input-group" id="pas">
                            <div class="input-group-addon">Protocol Address Space : </div>
                            <input type="text" class="form-control" placeholder="XXXX" name="ARPprotocolAddressSpace">
                        </div>
                    </div>
                </td>
            </tr>
                ...
                <td>
                    <div class="col-xs-3 col-md-3">
                        <div class="col-xs-12 col-md-12 input-group" id="hlen">
                            ...
                            <input type="text" class="form-control" placeholder="XX" name="ARPhlen">
                        </div>
                    </div>
                    <div class="col-xs-3 col-md-3">
                        <div class="col-xs-12 col-md-12 input-group" id="plen">
                            <div class="input-group-addon">PLEN : </div>
                            <input type="text" class="form-control" placeholder="XX" name="ARPplen">
                        </div>
                    </div>
                    <div class="col-xs-6 col-md-6">
                        <div class="col-xs-12 col-md-12 input-group" id="opcode">
                            <div class="input-group-addon">Opcode : </div>
                            <input type="text" class="form-control" placeholder="XXXX" name="ARPopcode">
                        </div>
                    </div>
                </td>
            </tr>
                ...
                <td>
                    <div class="col-xs-6 col-md-6">
                        <div class="col-xs-12 col-md-12 input-group" id="sha">
                            ...
                            <input type="text" class="form-control" placeholder="XX:XX:XX:XX:XX:XX" name="ARPsenderHardwareAddress">
                        </div>
                    </div>
                    <div class="col-xs-6 col-md-6">
                        <div class="col-xs-12 col-md-12 input-group" id="spa">
                            <div class="input-group-addon">Sender Protocol Address : </div>
                            <input type="text" class="form-control" placeholder="D.D.D.D" name="ARPsenderProtocolAddress">
                        </div>
                    </div>
                </td>
            </tr>
                ...
                <td>
                    <div class="col-xs-6 col-md-6">
                        <div class="col-xs-12 col-md-12 input-group" id="tha">
                            ...
                            <input type="text" class="form-control" placeholder="XX:XX:XX:XX:XX:XX" name="ARPtargetHardwareAddress">
                        </div>
                    </div>
                    <div class="col-xs-6 col-md-6">
                        <div class="col-xs-12 col-md-12 input-group" id="tpa">
                            <div class="input-group-addon">Target Protocol Address : </div>
                            <input type="text" class="form-control" placeholder="D.D.D.D" name="ARPtargetProtocolAddress">
                        </div>
                    </div>
                </td>
            </tr>
