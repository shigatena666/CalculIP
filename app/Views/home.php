        ...
        <div class="col-sm-6 col-md-4">
            <div class="panel panel-primary">
                ...
                <ul class="list-group">
                    ...
                    <a href="/CalculIP.new/Exercices/Conversion" class="list-group-item">
                    ...
                    <a href="/CalculIP.new/Exercices/TrouverClasse" class="list-group-item">
                        <dl class="dl-horizontal">
                    ...
                    <a href="/CalculIP.new/Exercises/TableRoutage" class="list-group-item">
                        <dl class="dl-horizontal">
                    ...
                    <a href="/CalculIP.new/Exercices" class="list-group-item">
                        <dl class="dl-horizontal">
        ...
        <div class="col-sm-6 col-md-4">
            <div class="panel panel-primary">
                ...
                <ul class="list-group">
                    ...
                    <a href="/CalculIP.new/Memos" class="list-group-item">
                        <dl class="dl-horizontal">
                            <dt>Plus de mémos</dt>
                            <dd>Voir le menu !</dd>
                        </dl>
